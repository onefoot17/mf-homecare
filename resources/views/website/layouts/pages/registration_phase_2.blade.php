    ...
    <div role="main" class="main">
        ...
        <section class="mf__section mf__section--maroon">
            <div class="container-xl mf__content">
                <div class="row">
                    <div class="col-md-10 mx-auto">
                        <h3 class="word-rotator slide appear-animation text-center" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="300">@lang( 'titles.registration-phase-2.Caregiver_Advantages' )</h3>
